            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 py-3">
                        ...
                        <input type="date" class="form-control" placeholder="Date" id="dClassDate" name="dClassDate"
                            required>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 py-3">
                        ...
                        <input type="number" class="form-control" placeholder="Total Marks" id="TxtTotalMarks"
                            name="TxtTotalMarks" min="0" max="100" maxlength="3" value="0" required>
                    </div>
                </div>

                <button class="btn btn-UNi" type="button" onclick="ShowSTDMARKS(1,1)">Create Marks Sheet</button>
                <button class="btn btn-danger" type="reset" onclick="ShowSTDMARKS(0,0)">Refresh</button>
            </div>
        </div>
